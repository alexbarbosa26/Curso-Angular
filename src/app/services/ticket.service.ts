...
export class TicketService {
  ...
  findByParams(page: number, count: number, assingnedToMe: boolean, t: Ticket) {
    ...
    return this.http.get(`${HELP_DESK_API}/api/ticket/${page}/${count}/${t.number}/${t.title}/${t.status}/${t.priority}/${assingnedToMe}`);
  }

  changeStatus(status: string, t: Ticket) {
    return this.http.put(`${HELP_DESK_API}/api/ticket/${t.id}/${t.status}`, t);
  }
